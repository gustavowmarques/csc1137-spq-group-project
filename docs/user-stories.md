# MediTrack – User Stories & Planning Game

This document captures the high-level user stories for the MediTrack Patient Management System.
These stories represent units of customer-visible functionality and are used for planning and estimation as introduced in Week 1 (Stories & Planning Game).
...
### 1. User Authentication & Access Control (3 days)
...
### 2. Patient Registration & Profile Management (5 days)
...
### 3. Patient Search & Record Viewing (4 days)
...
### 4. Appointment Scheduling & Status Management (6 days)
...
### 5. Visit Recording & Clinical Notes (5 days)
...
### 7. Administration & User Management (6 days)
...
- **Weeks 5–6:** Stories 1 & 2
- **Weeks 7–8:** Stories 3 & 4
- **Weeks 9–10:** Stories 5 & 6
